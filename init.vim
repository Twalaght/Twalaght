...
" ----- GUI and colour scheme settings -----
" Change settings and colour scheme if a GUI is running
if empty($TERM)
	colorscheme monokai
...
" TODO - Background remover, needed for transparent window
" else
...
inoremap <F5> <C-R>=stftime("%I:%M %p %a %d/%m/%Y")<CR>
